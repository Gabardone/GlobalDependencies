...
/**
 ...
 Normally implementations of this type will be created by the ``@Dependency`` macro and the implementation will use the
 ``DefaulDependencyValueFactory`` protocol to feed `defaultValue`. But a manual implementation can be built by hand if
 needed. In such case for a given `ExampleProtocol` depencency `Value` should be `any ExampleProtocol`.
 */
